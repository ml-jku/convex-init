...
def generate_mnist_plot():
    ...
    # stats = retrieve_five_number_summary(result_path, "convex1_mnist_rep?_*", tb_tag="valid/loss")
    # plot_five_number_summary(stats, "exp-ICNN", color=plt.cm.tab20(3), ax=ax1)
    # stats = retrieve_five_number_summary(result_path, "convex_mnist_rep?_*", tb_tag="valid/loss")
    # plot_five_number_summary(stats, "exp-ICNN + init", color=plt.cm.tab20(2), ax=ax1)
    ...
    # stats = retrieve_five_number_summary(result_path, "convex1_mnist_rep?_*", tb_tag="valid/acc")
    # plot_five_number_summary(stats, "exp-ICNN", color=plt.cm.tab20(3), ax=ax2)
    # stats = retrieve_five_number_summary(result_path, "convex_mnist_rep?_*", tb_tag="valid/acc")
    # plot_five_number_summary(stats, "exp-ICNN + init", color=plt.cm.tab20(2), ax=ax2)
...
def generate_cifar_plot():
    ...
    plot_five_number_summary(stats, "non-convex", color="gray", ax=ax1)
    # stats = retrieve_five_number_summary(result_path, "convex1_cifar_rep?_*", tb_tag="valid/loss")
    # plot_five_number_summary(stats, "exp-ICNN", color=plt.cm.tab20(3), ax=ax1)
    # stats = retrieve_five_number_summary(result_path, "convex_cifar_rep?_*", tb_tag="valid/loss")
    # plot_five_number_summary(stats, "exp-ICNN + init", color=plt.cm.tab20(2), ax=ax1)
    ...
    plot_five_number_summary(stats, "non-convex", color="gray", ax=ax2)
    # stats = retrieve_five_number_summary(result_path, "convex1_cifar_rep?_*", tb_tag="valid/acc")
    # plot_five_number_summary(stats, "exp-ICNN", color=plt.cm.tab20(3), ax=ax2)
    # stats = retrieve_five_number_summary(result_path, "convex_cifar_rep?_*", tb_tag="valid/acc")
    # plot_five_number_summary(stats, "exp-ICNN + init", color=plt.cm.tab20(2), ax=ax2)
